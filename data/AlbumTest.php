<?php
	namespace AlbumTest\Model\DAO;

	use Album\Model\DAO\Album as AlbumDao;
	...
	class AlbumTest extends PHPUnit_Framework_TestCase
	{
		public function testFetchAllReturnsAllAlbums()
		{
			...
			$albumDao = new AlbumDao($mockTableGateway);
			
			$this->assertSame($resultSet, $albumDao->fetchAll());
		}
		...
		public function testCanRetrieveAnAlbumByItsId()
		{
			...
			$albumTable = new AlbumDao($mockTableGateway);
